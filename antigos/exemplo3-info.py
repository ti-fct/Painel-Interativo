...
class FullScreenApp(QMainWindow):
    def __init__(self):
        ...
        self.btn_fct_conheca = QPushButton("Mapa salas e Labs")
        for btn in [self.btn_home, self.btn_horarios, self.btn_fct_numeros, self.btn_fct_conheca]:
        ...
        self.btn_fct_numeros.clicked.connect(lambda: self.carregar_url(
            "https://app.powerbi.com/view?r=eyJrIjoiNjUzMDMzOWUtNzViNS00NGYyLTk1YTYtMWY5MWE5OGI1YzAzIiwidCI6ImIxY2E3YTgxLWFiZjgtNDJlNS05OGM2LWYyZjJhOTMwYmEzNiJ9"))
        self.btn_fct_conheca.clicked.connect(lambda: self.carregar_url("https://prezi.com/view/MZjulFdzyMstq9zoDLVX/"))

        self.carregar_url("https://fct.ufg.br")
